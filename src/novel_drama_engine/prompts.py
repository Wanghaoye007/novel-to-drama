...
SOURCE_PARSER_SYSTEM = stage_system(
    ...
    (
        "按“题材模板识别 -> 主角欲望/阻力定位 -> 可见动作拆分 -> 道具/场景/强对白提取 -> "
        "低价值段落处理”的顺序工作。candidate_hooks 只能是可见动作、强对白、道具露出、"
        "威胁或反转，不能写成“观众想看什么”的抽象看点。"
    ),
    (
...
VIRAL_ASSET_SYSTEM = stage_system(
    ...
    (
        "按“频道/题材/爽感诊断 -> 核心困境提炼 -> 名场面分级 -> 情绪曲线抽样 -> "
        "风险替换策略”的顺序工作。"
    ),
    (
...
BIBLE_SYSTEM = stage_system(
    ...
    (
        "按“主线不可变事实 -> 人物功能合同 -> 关系张力 -> 台词风格 -> 禁止改动项”的顺序工作。"
    ),
    (
...
SCRIPT_SYSTEM = stage_system(
    ...
    (
        "按“前三秒可见冲突 -> 三波拉扯 -> 假打脸/钥匙兑现 -> 反派最后一装 -> "
        "动作或证据截断”的顺序写。"
    ),
    (
    ...
    return prompt_block(
        ...
        stage_instruction(
            ...
            (
                ...
                "能被剪成前三秒画面/声音。低价值段落要给出删除、合并、转 OS 或转动作的处理策略。"
            ),
            (
    ...
    return prompt_block(
        ...
        stage_instruction(
            ...
            (
                ...
                "例如“林晚在宴会厅撕开亲子鉴定，宾客当场倒向她”。改编风险必须给替换/合并方案。"
            ),
            (
    ...
    return prompt_block(
        ...
        stage_instruction(
            ...
            (
                ...
                "13. source_assets_to_keep：原文必须保留的名场面、金句、人物关系或道具；"
                "14. forbidden_shortcuts：禁止哪些偷懒写法。"
            ),
            (
    ...
    return prompt_block(
        ...
        stage_instruction(
            ...
            (
                ...
                "再写前三秒可见冲突、三波拉扯、假打脸/钥匙兑现、反派最后一装和结尾截断。"
            ),
            (
    ...
    return prompt_block(
        ...
        stage_instruction(
            ...
            (
                ...
                "随后重写前三秒冲突、三波拉扯、假打脸/钥匙、最狠短台词、最后 2 行钩子。"
            ),
            (
    ...
    return prompt_block(
        ...
        stage_instruction(
            ...
            (
                ...
                "SeriesEpisodeOutline 信息增量 -> 镜头可执行度 -> 台词效率 -> 最后 2 行追更钩子 -> "
                "状态连续性和题材模板一致性。"
            ),
            (
